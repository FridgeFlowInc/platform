...
class ProductTest(TestCase):
    ...
    def test_product_stats(self):
        ...
        expected1 = [
            {
                "positive_quantity_change_for_date": 25.0,
                "negative_quantity_change_for_date": 0.0,
                "date": "2000-01-01",
            },
            {
                "positive_quantity_change_for_date": 0.0,
                "negative_quantity_change_for_date": 8.0,
                "date": "2000-01-02",
            },
            {
                "positive_quantity_change_for_date": 0.0,
            ...
            {
                "positive_quantity_change_for_date": 0.0,
                "negative_quantity_change_for_date": 17.0,
                "date": "2000-01-04",
            },
        ]
        expected2 = [
